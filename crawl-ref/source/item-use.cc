...
// Daniel - Low do we need to add a vault entry to populate_list, which seems to be items on ground?
...
// Daniel - Low not sure what empty_check does, but it also works with oper_evoke
...
// Daniel - Mid item_to_oper maps items to their operation somehow. Need for vaults.
...
// Daniel - Done? High, make this func return a real value for coffer skill
skill_type get_highest_skill_from_group(vector<skill_type> skills)
{
    int highest_value = you.skill(skills[0]);
    int highest_index = 1;
    for (int i = 1; i < static_cast<int>(skills.size()); ++i)
    {
        if (you.skill(skills[i]) >= highest_value)
        {
            highest_value = you.skill(skills[i]);
            highest_index = i;
        }
    }
    return skills[highest_index];
}
...
{   
    ...
    vector<skill_type> aux_skills = {SK_FIGHTING, SK_UNARMED_COMBAT};
    vector<skill_type> stealth_skills = {SK_STEALTH};
    vector<skill_type> spellcasting_skills = {
        SK_SPELLCASTING
    };
    vector<skill_type> spell_school_skills = {
    ...
    case COFFER_ARMOR_MAJOR:
        ...
        break;
    case COFFER_MAGIC_MINOR:
        skills = spellcasting_skills;
        break;
    case COFFER_MAGIC_MAJOR:
        skills = spell_school_skills;
        break;
    case COFFER_STEALTH_MINOR:
    case COFFER_STEALTH_MAJOR:
        skills = stealth_skills;
        break;
    case COFFER_JEWELRY_MINOR:
    case COFFER_JEWELRY_MAJOR:
        skills = jewellery_skills;
        break;
    case COFFER_AUX_MINOR:
    case COFFER_AUX_MAJOR:
        skills = aux_skills;
...
// Daniel - Low tile_item_use is maybe using from the ground? Not sure. Need for vault. 
